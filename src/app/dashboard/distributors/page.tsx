...
export default function DistributorsPage() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const q = query(collection(db, "Dealers"), where("role", "==", "Distributor"));
  ...
  return (
    <div className="flex flex-1 flex-col">
      ...
      <main className="flex-1 p-4 md:p-8">
        <Card>
          <CardHeader>
            <CardTitle>Distributor Accounts</CardTitle>
            <CardDescription>Manage standard distributor accounts.</CardDescription>
          </CardHeader>
          <CardContent>
